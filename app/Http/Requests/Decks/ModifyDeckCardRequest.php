...
class ModifyDeckCardRequest extends FormRequest
{
    /**
     * The user may modify a card's quantity or remove it only on their own
     * deck, and only for a card that belongs to that deck.
     */
